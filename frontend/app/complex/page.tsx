...
const queryOptions: QueryOption[] = [
  ...
  { id: '4', title: 'Get Advanced Trading Metrics of Companies', description: 'This query returns advanced trading metrics of companies, including volatility, average daily range, upper half closes, VWAP, month price change, and quick ratio.'},
...
export function CarouselQueryDisplay() {
  ...
  const handleSubmitQuery = async (queryId: string | undefined) => {
    ...
    const queryUrlMap = {
      ...
      '4': "/stock/advanced-trading-metrics",
